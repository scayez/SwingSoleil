...
# def visualize_images_and_integration_animation_no_display(images_with_names, qh_list, ih_list, qv_list, iv_list, basler_images_with_names, positions, max_x, max_z, min_x, min_z):
#     fig, axs = plt.subplots(2, 2, figsize=(12, 10))
...
#         # print(f"File {frame} on {len(images_with_names)}")
#         print(f"File {frame} on {len(images_with_names)} : {images_with_names[frame][1]}")
#         clear_output(wait=True)
#         return im, line1, line2, im_basler, point
...
#     # save_animation_as_video(ani, 'C:/Users/cayez/Documents/DONNEES SIMON/LPCNO/Synchrotron/SOLSEIL_SWINGjuillet24/notebooks/images_test/video.gif')
#     save_animation_as_video(ani, 'video.gif')
