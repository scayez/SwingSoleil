...
def read_numpy_from_list(file_list: list) -> np.ndarray:
    ...
    Returns:
        np.ndarray: Combined numpy array from the list of numpy files. 
        For instances if it reads n files/arrays of shape (i,j), the returned array has the shape (n,i,j).
    """
    ...
    print('the list contains %d files' %len(file_list))
