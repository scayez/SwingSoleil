...
def save_exported_data(file,sample_name=None, eiger=None, basler_image=None, position=None, params=None, time_stamps=None, transmission=None, integration=None, maskfile=None ):
    ...
    # output_dir =file_num + '_'+  output_dir 
    ...
    if integration is not None:
        ...
        plot_integration(integration,sample_name , time_stamps  ,data_dir , plot=None , save_path = os.path.join(integration_dir))
        #def plot_integration(integration,sample_name = None, time_stamps = None ,data_folder = None, plot = None, save_path = None):
        ...
        for file in files:
            if file.endswith('.h5'):
                ...
                try:
                    ...
                    sample_name, _, _, _, _, _, transmission = extract_from_h5(file_path, print_output=False)
...
#         ax.set_xlabel('q_iso')  # X-axis label
#         ax.set_ylabel('i_iso')  # Y-axis label
